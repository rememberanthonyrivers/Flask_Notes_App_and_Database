...
# from .auth import login # helps us manage all the login related things 
...
def create_app():
    ...
    def load_user(id):
        return User.query.get(int(id))  # .get knows its looking for a primary key 

    return app


def create_database(app):       #   this method is going to check if the databse exits already 
